...
'name' => __( 'Upper Footer Widget Area', 'gridded' ),
'id' => 'primary-widget-area',
'before_widget' => '<div id="%1$s" class="desktop-3 tablet-3 mobile-3 widget-container %2$s"><div>',
...
register_sidebar( array (
'name' => __( 'Lower Footer Widget Area', 'gridded' ),
'id' => 'footer-widget-area',
'before_widget' => '<div id="%1$s" class="desktop-12 tablet-6 mobile-3 widget-container %2$s"><div>',
'after_widget' => "</div></div>",
'before_title' => '<h3 class="widget-title">',
'after_title' => '</h3>',
) );
...
add_image_size( 'newswindow-thumb', 550, 250, true );
...
function include_jQuery() {
    if (!is_admin()) {
        ...
        wp_register_script('jquery', '/assets/javascripts/jquery.js', false, '1.11.1'); 
        wp_enqueue_script('jquery');
    }
}
...
function onepage_script() {
  wp_register_script('onepage', get_template_directory_uri() . '/assets/javascripts/jquery.onepage-scroll.min.js','1', true);
...
function template_scripts() {
  wp_register_script('myscripts', get_template_directory_uri() . '/assets/javascripts/scripts.min.js','1', false);
